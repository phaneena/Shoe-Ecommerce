...
function Cart() {
    ...
    const decrement= (id)=>{
        ...
        // try{
        //     const prodresponse=axios.get(`http://localhost:5000/Products/${product.id}`)
        //     const currproduct=prodresponse.data

        //     const useresponse=axios.get(`http://localhost:5000/users/${id}`)
        //     const curruser=useresponse.data
        //     const existingCartItem=curruser.find((item)=>item.id===product.id)
